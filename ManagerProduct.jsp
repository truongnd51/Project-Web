        ...
        <div class="table-wrapper" style="margin-left: 140px">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success" style="background-color: #5d5f66" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add Product</span></a>						
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    <c:forEach items="${listP}" var="o">
                        <tr>
                            ...
                            <td>${o.name}</td>
                            <td>
                                <img photo2 src="${o.image}" height="70px" width="70px">
                            </td>
                            <td>${o.quantity}</td>
                            <td>$${o.price}</td>
                            <td>
