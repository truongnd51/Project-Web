...
public class ProductControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        String cateID = request.getParameter("id");//da lay dc category id
         DAO dao=new DAO();
         
         List<Product> listA = dao.getAllProduct();
        List<Category> listC = dao.getAllCategory();
        List<Product> listById=dao.getProductByCId(cateID);
        ...
        int page, numperpage=12;
         ...
         start = (page -1)*numperpage;
          ...
          List<Product> list = dao.getListByPage(listById, start, end); 
